...
import { Menu, X, LogOut, Home, Bell, BookOpen, User, Settings, Users, Key, ArrowLeft } from "lucide-react";
        ...
        <div className="lg:ml-64">
          ...
          <main className="p-6 lg:p-8">
            <div className="bg-yellow-100 p-6 rounded-xl text-center">
              ...
              <Link href="/dashboard/parent" className="text-blue-600 underline mt-3 inline-block">
                Back to Dashboard
              </Link>
            </div>
          </main>
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="lg:ml-64">
        ...
        {/* Main Content Area - YOUR ORIGINAL PROFILE CODE */}
        <main className="p-6 lg:p-8">
          <div className="space-y-6">
            {/* Header */}
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Profile</h1>
              <p className="text-gray-500">View your account information and linked students</p>
            </div>
                ...
                {children.length === 0 ? (
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-400 mt-2">
                      Please contact the administrator to link students.
                    </p>
                  </div>
                ) : (
