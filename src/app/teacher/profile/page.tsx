            ...
            <div style={{ padding: "32px 24px" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", marginBottom: 28 }}>
                ...
                <div style={{ marginTop: 10, display: "inline-flex", alignItems: "center", gap: 6, borderRadius: 999, background: "#f5f3ff", padding: "5px 14px", boxShadow: "0 0 0 1px #ddd6fe" }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 700, color: "#6d28d9", textTransform: "capitalize" }}>
                    {profile.role}
                  </span>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <InfoItem icon={<BookOpen style={{ width: 16, height: 16 }} />} label="Assigned Courses" value={String(coursesCount)} />
                <InfoItem
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  {[
                    ...
                    <div key={field.label} style={{ borderRadius: 14, border: "1.5px solid #f1f5f9", background: "#f8fafc", padding: "14px 16px" }}>
                      <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#94a3b8", margin: "0 0 6px" }}>
                        {field.label}
                      </p>
                      <p style={{ fontSize: 14, fontWeight: 600, color: "#0f172a", margin: 0, textTransform: field.label === "Role" ? "capitalize" : "none" }}>
                        {field.value}
                      </p>
                    </div>
                  ))}
          ...
          <div style={{ width: "100%", maxWidth: 420, background: "#fff", borderRadius: 20, overflow: "hidden", boxShadow: "0 24px 64px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, padding: "14px 24px 20px", borderTop: "1px solid #f1f5f9" }}>
              ...
              <button
                ...
                style={{ height: 40, borderRadius: 12, border: "none", background: pwSuccess ? "#10b981" : pwSaving ? "#a78bfa" : "linear-gradient(135deg, #7c3aed, #6d28d9)", color: "#fff", fontWeight: 600, fontSize: 13, padding: "0 20px", cursor: pwSaving || pwSuccess ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: 6 }}
              >
                {pwSuccess ? (
                  <>
                    <Check style={{ width: 14, height: 14 }} /> Updated!
                  </>
                ) : pwSaving ? (
                  "Updating…"
                ) : (
