...
export default function AdminReportsPage() {
  ...
  async function fetchData() {
    ...
    const [{ data: profilesData }, { data: coursesData }, { count }] =
      await Promise.all([
        supabase
          .from("profiles")
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Monitor LMS activity, users, enrollments, and academic resources
          across the platform.
        </p>
      </div>
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 48,
                  borderRadius: 14,
                  background: `linear-gradient(135deg, ${cfg.iconFrom}, ${cfg.iconTo})`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  boxShadow: `0 4px 14px ${cfg.iconFrom}44`,
                  flexShrink: 0,
                }}
              >
                {STAT_ICONS[cfg.key]}
      ...
      >
          ...
          <div style={{ padding: "20px 20px 4px" }}>
            ...
            >
              <div>
                ...
                >
                  Top 10 latest platform registrations
                </p>
              </div>
        ...
        >
          <div
            style={{
              height: 5,
              background: "linear-gradient(90deg, #6366f1, #818cf8, #0891b2)",
            }}
          />
          ...
          <div style={{ padding: "20px 20px 4px" }}>
            ...
            >
              <div>
                ...
                >
                  Top 5 latest courses added to the LMS
                </p>
              </div>
          ...
          <div style={{ padding: "0 12px 16px" }}>
            {loading ? (
              <LoadingRow text="Loading courses..." />
